...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('accounts', '0002_move_profile'),
    )
    
    def forwards(self, orm):
        # moving profile to accounts app, no need to drop or create
        pass
    ...
    models = {
        ...
        'trucks.companylink': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'links'", 'to': "orm['trucks.Company']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
