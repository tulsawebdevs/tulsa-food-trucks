...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('phone', self.gf('django_localflavor_us.models.PhoneNumberField')(unique=True, max_length=20)),
        ...
        db.create_table(u'accounts_phoneverification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('sent_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('value', self.gf('django_localflavor_us.models.PhoneNumberField')(max_length=20)),
        ))
        db.send_create_signal(u'accounts', ['PhoneVerification'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_phoneverification')
    ...
    models = {
        ...
        u'accounts.phoneverification': {
            'Meta': {'object_name': 'PhoneVerification'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sent_at': ('django.db.models.fields.DateTimeField', [], {}),
            'value': ('django_localflavor_us.models.PhoneNumberField', [], {'max_length': '20'})
        },
        u'accounts.user': {
